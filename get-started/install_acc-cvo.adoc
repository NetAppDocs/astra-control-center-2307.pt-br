...
Astra Trident 22,10 ou mais recente instalado e configurado e NetApp ONTAP versão 9,8 ou mais recente como um back-end de storage [[aws-registry]]
...
| Astra Trident (instalado como parte da descoberta de clusters do Kubernetes no NetApp BlueXP , anteriormente chamado Gerenciador de nuvem)  a| 
Astra Trident 22,10 ou mais recente instalado e configurado e NetApp ONTAP versão 9,8 ou mais recente como um back-end de storage [[gcp-registry]]
...
Astra Trident 22,10 ou mais recente instalado e configurado e o NetApp ONTAP versão 9,8 ou mais recente será usado como back-end de storage [[azure-registry]]
